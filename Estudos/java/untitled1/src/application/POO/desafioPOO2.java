...
public class desafioPOO2 {
    public static void main(String[] args) {
        ...
        pedidos.add(new Pedido(2, new Cliente(2, "Davi", "Davi@gmail.com"), produtos, new Endereco("Rua José Giarola", "200 A", "Lavras", "Minas Gerais"), Status.EM_ANDAMENTO));
        pedidos.add(new Pedido(3, new Cliente(3, "Renan", "Renan@gmail.com"), produtos, new Endereco("Rua raimunda Marques Guimaraẽs", "40 B", "Lavras", "Minas Gerais"), Status.EM_ANDAMENTO));
        pedidos.add(new Pedido(4, new Cliente(4, "Ravi", "Ravi@gmail.com"), produtos, new Endereco("Rua 2", "140", "Ijaci", "Minas Gerais"), Status.EM_ANDAMENTO));
        pedidos.add(new Pedido(5, new Cliente(5, "João", "João@gmail.com"), produtos, new Endereco("Rua Primeiro de maio", "275", "Belo Horizonte", "Minas Gerais"), Status.EM_ANDAMENTO));
