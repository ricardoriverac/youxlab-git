...
values (1, 'Manuel', '88828383821', '32323', '2001-01-30', 'M', 'estudante', 'brasileira', 'Rua Joaquim Nabuco', '23', 'casa', 'Cidade Nova', 'Porto União', 'SC');

insert into cliente (idcliente,nome, cpf , rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf )
values (2, 'Geraldo','12343299921', '56565', '2000-01-15', 'M', 'estudante', 'brasileira', 'Rua das Limas', '200', 'ap', 'Centro', 'Poro Uniao', 'SC');

insert into cliente (idcliente,nome, cpf , rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf )
values (3, 'Carlos', '87732323227', '55463', '1964-10-01', 'M', 'Pedreiro', 'brasileira', 'Rua das Larangeiras', '300', 'Apart', 'Centro', 'P.União', 'SC');

insert into cliente (idcliente,nome, cpf , rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf )
values (4, 'Adriana','12321222122', '98777', '1989-09-10', 'F', 'Jornalista', 'brasileira', 'Rua das Limas', '240', 'Casa', 'São Pedro', 'Porto Vitoria', 'PR');

insert into cliente (idcliente,nome, cpf , rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf )
values (5, 'Amanda', '99982838828', '28382', '1991-03-04', 'F', 'Jorn.', 'Italiana', 'Av.Central', '100',null, 'São Pedro', 'General Carneiro', 'PR');

insert into cliente (idcliente,nome, cpf , rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf )
values (6, 'Ãngelo', '99982828181', '12323', '2000-01-01', 'M', 'Professor', 'brasileira', 'Av.Beira Mar', '300',null, 'Ctr.', 'São Paulo', 'SP');

insert into cliente (idcliente,nome, cpf , rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf )
values (7, 'Anderson', null, null, null, 'M', 'Prof.', 'Italiano', 'Av.Brasil', '100', 'Apartamento', 'Santa Rosa', 'Rio de Janeiro', 'SP');

insert into cliente (idcliente,nome, cpf , rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf )
values (8, 'Camila', '9998282828', '2001-10-10', '2000-01-01', 'F', 'Professora', 'Norte Americana', 'Rua Central', '4333', null, 'Centro', 'Uberlandia', 'MG');
...
insert into cliente (idcliente,nome, cpf , rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf )
values (11, 'Fernanda', null, null, null, 'F', 'Estudante', 'brasileiro', null, null, null, null, 'Porto União', 'SC');
...
insert into cliente (idcliente,nome, cpf , rg, data_nascimento, genero, profissao, nacionalidade, logradouro, numero, complemento, bairro, municipio, uf )
values (15, 'Jessica',null, null, null, 'F', null, null, null, null, null, null, 'União da Vitória', 'PR');
...
select nome || ' - '|| logadouro ||' - '|| numero ||' - '||complemento||' - '|| bairro ||'- '|| municipio||' - '||uf from clente;

-- AULA 17

select * from cliente;
update cliente set nome = 'Teste' where idcliente = 1;
update cliente set nome = 'Adriano', genero = 'M', numero ='234' where idcliente = 4;
...
update cliente set data_nascimento = '1978-04-01', genero = 'M' where idcliente = 15;
update cliente set genero = 'F', profissao = 'Professora', numero = '123' where idcliente = 15;
...
insert into nacionalidade (idnacionalidade, nome) values (3, 'Norte_Americana');
insert into nacionalidade (idnacionalidade, nome) values (4, 'Alemã');

select * from nacionallidade;
...
insert into complemento (idcomplemento, nome) values (2, 'Aprtamento');
...
alter table cliente drop constraint fk_cln_idnacionalidade;


alter table nacionallidade rename to nacionalidade;
...
insert into produto (idproduto, idfornecedor, nome, valor)
values (6,2, 'Memoria RAM', 100);
insert into produto (idproduto, idfornecedor, nome, valor)
values (7,2, 'Gabinete', 35);
...
create table transportadora (
	...
	constraint pk_tns_idtransportadora primary key (idtransportadora),
	constraint un_tns_unique unique (nome)
	
);

insert into transportadora (idtransportadora, nome) values (1,'BS.Transportes');
insert into transportadora (idtransportadora, nome) values (2,'Uniao Transportes');
...
create table pedido (
	...
	constraint pk_add_idpedido  primary key (idpedido),
...
insert into pedido (idpedido,data_pedido, valor, idcliente,idtransportadora,idvendedor)
values (9,'2008-04-07', 1300, 13,null,8);
...
insert into pedido (idpedido,data_pedido, valor, idcliente,idtransportadora,idvendedor)
values (12,'2008-04-20', 500, 15,2,1);
...
--insert into
	--pedido (idpedido,data_pedido, valor, idcliente,idtransportadora,idvendedor)
--values
...
insert into pedido_produto (idpedido, idproduto, quantidade, valor_unitario) values (7,7,5,35);
...
insert into pedido_produto (idpedido, idproduto, quantidade, valor_unitario) values (11,2,1,100);
...
insert into pedido_produto (idpedido, idproduto, quantidade, valor_unitario) values (15,6,3,100);
...
select nome, (valor + (valor * 0.1)) as preco_reajustado from produto 
...
select * from cliente where logadouro is null

--16. Os clientes que moram em avenidas.
select * from cliente where logadouro like 'Av%'
...
select * from transportadora where logadouro is not null
...
select count(logadouro) from transportadora
...
select idfornecedor, avg(valor) from produto group by idfornecedor having 
idfornecedor = 1;
...
select sum(valor) from pedido where data_pedido between '2008-04-01' and '2009-12-10';
...
select avg(valor) from pedido where idpedido = 15;
...
select idvendedor, count(pedido) from pedido group by idvendedor;

---28. A quantidade de pedidos agrupados por cliente.
select idcliente, count(pedido) from pedido group by idcliente;
...
select count(*) from produto group by produto;

--33. O somatório do valor dos produtos dos pedidos, agrupado por pedido.
select idpedido,sum(valor_unitario) from pedido_produto group by idpedido order by idpedido;
...
select idpedido, count(*) from pedido_produto group by idpedido;
select *  from pedido_produto
...
select
	...
	brr.bairro as bairro,
	mnc.municipio as municipio,]
	uf.nome as estado,
	uf.sigla
from
	cliente as cln
...
select 
	prd.nome as profissao,
	prd.valor,
	fcd.nome 
from produto prd
left outer join 
	 fornecedor fcd on prd.idfornecedor = fcd.idfornecedor
...
left outer join
	transportadora tr on tr.idtransportadora = tr.idtransportadora
left outer join 
...
from pedido_produto as prd
left outer join 
	produto prdt on prd.idproduto = prdt.idproduto
...
from produto pdd
left outer join
	fornecedor fcn on pdd.idfornecedor = fcn.idfornecedor
group by 
	fcn.nome
...
select 
 pdd.nome,
 count(prd.quantidade) as quantidade
from pedido_produto prd
left outer join
	produto pdd on prd.idproduto = pdd.idproduto
group by 
	pdd.idproduto
...
select 
  prd.data_pedido,
  sum(pdd.valor_unitario) soma 
 from pedido_produto pdd
left outer join 
 	pedido prd on pdd.idpedido = prd.idpedido
group by prd.idpedido
...
left outer join 
	pedido dat on pdp.idpedido = dat.idpedido
group by  dat.idpedido



--AULA COMANDOS ADICIONAIS
...
from produto
-- SUBCONSULTAS
-- SELECIPONAR A DATA DO PEDIDO E O VALOR ONDE O VALOR 
-- SEJA MAIOR QUE A MEDIA DPOS VALORES DO PEDIDO
select 
	data_pedido,
	valor
from
...
cwhere valor > (select avg(valor) from pedido)
...
left outer join 
	...
	where
		mun.idmunicipio = (select c.idmunicipio from cliente c where c.nome like 'Manoel') and cln.nome != 'Manuel';
...
select
	cln.nome as cliente
	(select count(pdd.idpedido) as total
	from
		pedido pdd
left outer join
	cliente cln on pdd.idcliente = cln.idcliente
...
select
	...
	cln.nome as complemento,
	mnc.idmunicipio as municipio,
...
from
	pedido_produto pdp
left outer join 
	produto prd on pdp.idproduto = prd.idprodudo
