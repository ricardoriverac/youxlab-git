...
insert into pedido (idcliente, idtransportadora, idvendedor, data_pedido, valor) values (2,2,5,'2009-04-01',400);
insert into pedido (idcliente, idtransportadora, idvendedor, data_pedido, valor) values (1,1,7,'2009-04-09',700);
...
insert into profissao (nome) values ('Teste');
...
insert into transportadora (nome) values ('Teste');
...
insert into uf (nome, sigla) values ('Teste', 'TE');
...
insert into vendedor (nome) values ('Teste');
